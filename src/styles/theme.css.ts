...
createGlobalTheme(":root", vars, {
  color: {
    ...
    win: `oklch(from ${vars.color.success} l c h / 0.35)`,
    lose: `oklch(from ${vars.color.error} l c h / 0.35)`,
...
createGlobalTheme(":root.dark", vars, {
  color: {
    ...
    success: "oklch(0.73 0.18 142)",
    error: "oklch(0.65 0.25 27)",
    win: `oklch(from ${vars.color.success} l c h / 0.05)`,
    lose: `oklch(from ${vars.color.error} l c h / 0.05)`,
    ...
    popupBackground: `rgb(from ${vars.color.background} r g b / 0.95)`,
  },
});

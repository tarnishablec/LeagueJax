...
export type AchievedTier = { division: number, queueType: QueueType, tier: Tier, };
...
export type RankedTierSummary = { achievedTiers: Array<AchievedTier>, summonerId: number, };
